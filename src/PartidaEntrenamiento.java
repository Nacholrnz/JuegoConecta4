public class PartidaEntrenamiento extends Partida implements ITableroVisual{
    JugadorReal jug1;
    JugadorMaquina jug2;
    Tablero tablero;
    Validar validar;
    ...
    public PartidaEntrenamiento(JugadorReal jug1,JugadorMaquina jug2,Tablero tablero) {
        this.jug1 = jug1;
        this.jug2 = jug2;
